...
# Time-stamp: <2026-09-22 15:00:36 mura>
:QUARTO:
...
- 応用上重要な分布
   ...
   - 連続分布 (絶対連続な分布)
** 確率質量関数
#+begin_callout-note :icon false :title "離散分布を記述する方法"
...
** 推定量の漸近正規性
#+begin_callout-note :icon false :title "漸近正規性"
...
#+begin_callout-important :icon false :title "最尤推定量"
\(\Theta\) を尤度関数の定義域として，
